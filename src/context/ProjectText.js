...
export const ProjectDetailText = [
  ...
  },
  {
    ...
    result: [
      'Google Login API를 활용하여 강력한 사용자 인증 시스템을 구축했습니다. 사용자 편의성과 보안을 고려하여 손쉬운 로그인 경험을 제공하며, 개인정보 관리에 대한 효과적인 솔루션을 확보했습니다.',
      'Kakao Map API를 활용하여 지리적 데이터 시각화를 강화했습니다. 다양한 지도 기능을 통해 사용자에게 직관적이고 효과적인 지리 정보를 제공하며, 애플리케이션의 사용자 경험을 향상시켰습니다.',
      '프론트와 백엔드의 서버를 분리배포하여 시스템 유연성을 향상시켰습니다. 클라이언트와 서버 간의 독립성을 유지하면서, 효율적인 확장과 업데이트를 가능케 하여 개발 생산성과 안정성을 동시에 향상시켰습니다.',
      'AWS 서비스를 사용하여 안정적이고 확장 가능한 개발 환경을 조성했습니다. 다양한 클라우드 기술을 활용하여 서버 관리 및 인프라 구축을 효율적으로 수행하고, 안전한 데이터 저장 및 전송을 보장하였습니다.',
      'Scss와 SVG를 겹합하여 Interactive한 개발을 경험했습니다. Scss를 활용하여 스타일링을 효율적으로 구성하고, SVG를 활용하여 다양한 그래픽 요소를 삽입하며 상호작용성을 부여했습니다. 이를 통해 독특하고 다이내믹한 웹 페이지를 만들어 사용자 경험을 높였습니다.',
